...
<div id="BackLink"><a href="http://localhost:8080/jpetstore/actions/Catalog.action">
Return to Main Menu
</a>
</div>
<div id="Catalog">
...
<stripes:form
	...
	<table>
		...
		<c:forEach var="cartItem" items="${actionBean.cart.cartItems}">
			<tr>
				<td>
				<a href = "http://localhost:8080/jpetstore/actions/Catalog.action?viewItem=&itemId=${cartItem.item.itemId}">
